...
const css = {
  code: ".svelte-hbd2su.svelte-hbd2su.svelte-hbd2su{box-sizing:border-box}@font-face{font-family:'Fira Code', monospace;font-display:optional;src:url('https://fonts.googleapis.com/css2?family=Fira+Code:wght@300;400;500;600;700&display=swap')}#svelte{width:100vw;height:100%;max-width:900px;display:flex;flex-direction:column;justify-content:space-between}html,body{transition:background-color 0.2s ease 0s;position:relative;width:100%;height:100%;overflow:auto;font-family:'Fira Code', monospace;background-color:#0a0908}body{background-color:var(--background);background-size:200% 200%;color:white;margin:0;box-sizing:border-box;display:grid;line-height:1.75;place-items:center;height:100%;overflow-x:hidden}h1{border:0}::selection{color:white;background:#ca3c25}::-webkit-scrollbar{width:8px;height:8px;border-radius:1px}::-webkit-scrollbar-thumb{background-color:#fafffd;border-radius:3px}::-webkit-scrollbar-track{background-color:transparent;border-radius:1px}@media(min-width: 900px){body{padding:0 100px}}a{text-decoration:none}a{text-decoration:none}a.svelte-hbd2su.svelte-hbd2su.svelte-hbd2su{color:rgb(0, 100, 200);text-decoration:none}a.svelte-hbd2su.svelte-hbd2su.svelte-hbd2su:hover{text-decoration:underline}a.svelte-hbd2su.svelte-hbd2su.svelte-hbd2su:visited{color:rgb(0, 80, 160)}.modalContainer.svelte-hbd2su div.svelte-hbd2su.svelte-hbd2su{display:flex;margin-bottom:20px}.modalContainer.svelte-hbd2su p.svelte-hbd2su.svelte-hbd2su{margin:0}.tooltip{visibility:hidden}.cookieContainer.svelte-hbd2su.svelte-hbd2su.svelte-hbd2su{background:white;border-radius:0px;text-align:center;width:100%;height:30px;color:black;padding:30px;display:flex;justify-content:space-evenly;align-items:center;position:fixed;bottom:0px;left:0;right:0;margin-left:auto;margin-right:auto}.cookieContainer.svelte-hbd2su>p.svelte-hbd2su>a.svelte-hbd2su{text-decoration:underline}.cookieContainer.svelte-hbd2su>div.svelte-hbd2su.svelte-hbd2su{cursor:pointer}footer.svelte-hbd2su.svelte-hbd2su.svelte-hbd2su{font-size:16px;font-weight:400;padding:30px 0;max-width:900px;text-align:center;width:100%}footer.svelte-hbd2su a.svelte-hbd2su.svelte-hbd2su{text-decoration:none;color:#4158d0}footer.svelte-hbd2su .me.svelte-hbd2su.svelte-hbd2su{color:#ff3e00}@media(min-width: 900px){.tooltip{visibility:visible}}@media(min-width: 600px){.cookieContainer.svelte-hbd2su.svelte-hbd2su.svelte-hbd2su{background:white;border-radius:50px;text-align:center;width:350px;height:30px;color:black;padding:0 10px;display:flex;justify-content:space-evenly;align-items:center;position:fixed;bottom:50px;left:0;right:0;margin-left:auto;margin-right:auto}}",
  map: null
};
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return ` ${showCookieModal && cookieEnabled ? `<div class="cookieContainer svelte-hbd2su"><p class="svelte-hbd2su" data-svelte-h="svelte-1iwts5v">🍪 This website use <a href="privacy-policy" class="svelte-hbd2su">Cookies.</a></p> <div role="button" tabindex="0" class="svelte-hbd2su" data-svelte-h="svelte-1bl8vgs">✕</div></div>` : ``} ${validate_component(Modal, "Modal").$$render($$result, {}, {}, {
    content: () => {
      return `<div slot="content" class="modalContainer svelte-hbd2su"><h1 class="svelte-hbd2su" data-svelte-h="svelte-7qu70e">Email:</h1> <div class="svelte-hbd2su"><p class="svelte-hbd2su">${escape(Email)}</p>
			 
			<div class="tooltip svelte-hbd2su">${validate_component(Tooltip, "Tooltip").$$render($$result, { tooltip: "Copy" }, {}, {
        default: () => {
          return `<div id="clipboard" role="button" tabindex="0" class="svelte-hbd2su"><div class="svelte-hbd2su">${validate_component(FaCopy, "FaCopy").$$render($$result, {}, {}, {})}</div></div>`;
        }
  ...
  })} ${validate_component(NavBar, "Navbar").$$render($$result, { segment: $page.url.pathname }, {}, {})} ${slots.default ? slots.default({}) : ``} <footer class="svelte-hbd2su" data-svelte-h="svelte-1homwn6">Created by <a class="me svelte-hbd2su" href="/about">Fazril </a>with
</footer>`;
});
export {
  Layout as default
